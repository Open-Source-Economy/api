...
export class ServiceCategory {
  ...
  constructor(id: ServiceCategoryId, name: string, parentCategory: string | null, hasResponseTime: boolean, createdAt: Date, updatedAt: Date) {
    this.id = id;
    this.name = name;
  ...
  static fromBackend(row: any): ServiceCategory | ValidationError {
    ...
    return new ServiceCategory(new ServiceCategoryId(id), name, parentCategory ?? null, hasResponseTime, createdAt, updatedAt);
  }
}
