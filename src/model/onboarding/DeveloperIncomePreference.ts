...
export class DeveloperIncomePreference {
  ...
  constructor(id: DeveloperIncomePreferenceId, developerProfileId: DeveloperProfileId, incomeType: IncomeType, createdAt: Date, updatedAt: Date) {
    this.id = id;
  ...
  static fromBackend(row: any): DeveloperIncomePreference | ValidationError {
    ...
    return new DeveloperIncomePreference(new DeveloperIncomePreferenceId(id), new DeveloperProfileId(developerProfileId), incomeType, createdAt, updatedAt);
  }
}
